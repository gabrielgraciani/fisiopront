...
import { IndexContainer, Title, AccordionContainer, AccordionTitle, Accordion, ModalContent, AnswerTitle, SelectAnswerButton, Answer, ScoreResultContainer, ScoreText } from './styles';
...
export function BarthelIndex(): JSX.Element {
    ...
    useEffect(() => {
        setBarthelScore(alimentationScore + bathScore + routineScore + dressUpScore + intestineScore + urinaryScore)
    }, [alimentationScore, bathScore, routineScore, dressUpScore, intestineScore, urinaryScore])
            ...
            <ScrollView>
                <IndexHeader indexName={'Índice de Barthel'} />
                    <AccordionContainer>
                        ...
                        <Accordion>
                            <AccordionTitle>{ alimentationScore >= 0 ? `Score ${alimentationScore}` : 'Selecione um valor' }</AccordionTitle>
                            <TouchableWithoutFeedback onPress={() => toggleModal('alimentation')}>
                                <AntDesign name="down" size={24} color="#fafafa" />
                            </TouchableWithoutFeedback>
                        </Accordion>
                        <Title>Banho</Title>
                        <Accordion>
                            <AccordionTitle>{ bathScore >= 0 ? `Score ${bathScore}` : 'Selecione um valor' }</AccordionTitle>
                        ...
                        <Accordion>
                            <AccordionTitle>{ routineScore >= 0 ? `Score ${routineScore}` : 'Selecione um valor' }</AccordionTitle>
                        ...
                        <Accordion>
                            <AccordionTitle>{ dressUpScore >= 0 ? `Score ${dressUpScore}` : 'Selecione um valor' }</AccordionTitle>
                        ...
                        <Accordion>
                            <AccordionTitle>{ intestineScore >= 0 ? `Score ${intestineScore}` : 'Selecione um valor' }</AccordionTitle>
                        ...
                        <Accordion>
                            <AccordionTitle>{ urinaryScore >= 0 ? `Score ${urinaryScore}` : 'Selecione um valor' }</AccordionTitle>
                        ...
                        <Modal isVisible={isAlimentationModalVisible} style={{margin: 0}} onBackdropPress={() => setAlimentationModalVisible(false)}>
                            <ModalContent>
                                <Answer>
                                ...
                                <Answer>
                                    <AnswerTitle>Precisa de ajuda para cortar, passar manteiga, etc, ou dieta modificada</AnswerTitle>
                                    <TouchableWithoutFeedback  onPress={() => {
                                        toggleModal('alimentation')
                        ...
                        <Modal isVisible={isBathModalVisible} style={{margin: 0}} onBackdropPress={() => setBathModalVisible(false)}>
                            <ModalContent>
                                <Answer>
                        ...
                        <Modal isVisible={isRoutineModalVisible} style={{margin: 0}} onBackdropPress={() => setRoutineModalVisible(false)}>
                            <ModalContent>
                                <Answer>
                                    <AnswerTitle>Precisa de ajuda com a higiene pessoal</AnswerTitle>
                                    <TouchableWithoutFeedback  onPress={() => {
                                        toggleModal('routine')
                                        setRoutineScore(0)
                                        }}>
                                ...
                                <Answer>
                                    <AnswerTitle>Independente rosto/cabelo/dentes/barbear</AnswerTitle>
                                    <TouchableWithoutFeedback  onPress={() => {
                                        toggleModal('routine')
                                        setRoutineScore(5)
                                        }}>
                        ...
                        <Modal isVisible={isDressUpModalVisible} style={{margin: 0}} onBackdropPress={() => setDressUpModalVisible(false)}>
                            <ModalContent>
                                <Answer>
                                    <AnswerTitle>Dependente</AnswerTitle>
                                    <TouchableWithoutFeedback  onPress={() => {
                                ...
                                <Answer>
                                    <AnswerTitle>Precisa de ajuda mas consegue fazer uma parte sozinho</AnswerTitle>
                                    <TouchableWithoutFeedback  onPress={() => {
                                        toggleModal('dressUp')
                                        setDressUpScore(10)
                                        }}>
                                ...
                                <Answer>
                                    <AnswerTitle>Independente (incluindo botões, zipers, laços, etc.)</AnswerTitle>
                                    <TouchableWithoutFeedback  onPress={() => {
                                        toggleModal('dressUp')
                                        setDressUpScore(10)
                                        }}>
                        ...
                        <Modal isVisible={isIntestineModalVisible} style={{margin: 0}} onBackdropPress={() => setIntestineModalVisible(false)}>
                            <ModalContent>
                                <Answer>
                        ...
                        <Modal isVisible={isUrinaryModalVisible} style={{margin: 0}} onBackdropPress={() => setUrinaryModalVisible(false)}>
                            <ModalContent>
                                <Answer>
                                    <AnswerTitle>Incontinente, ou cateterizado e incapaz de manejo</AnswerTitle>
                                    <TouchableWithoutFeedback  onPress={() => {
                                        toggleModal('urinary')
                                        setUrinaryScore(0)
                                        }}>
